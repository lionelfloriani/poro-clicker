...
const buttonBonusMultiplier: HTMLElement | null =
  document.getElementById('bonus-multiplier');
const buttonBonusMultiplier5: HTMLElement | null =
  document.getElementById('bonus-multiplier5');
const buttonBonusMultiplier10: HTMLElement | null =
  document.getElementById('bonus-multiplier10');
const buttonBonusAutoClicker: HTMLElement | null =
  document.getElementById('bonus-auto-clicker');
const buttonBonusTime: HTMLElement | null =
  document.getElementById('bonus-time');
...
const clicksSecondes: HTMLElement | null =
  document.getElementById('autoclicksecond');
...
let pointsPerClick: number = parseInt(
  localStorage.getItem('pointsPerClick') || '1'
);
let clicks: number = parseInt(localStorage.getItem('click') || '0');
let totalObtainScore: number = parseInt(
  localStorage.getItem('totalObtainScore') || '0'
);
let totalSpentScore: number = parseInt(
  localStorage.getItem('totalSpentScore') || '0'
);
let purchaseCount = parseInt(
  localStorage.getItem('numberPurchaseAutoClick') || '0'
);
...
let bonusPriceAutoClicker: number = parseInt(
  localStorage.getItem('priceAutoClicker') || priceAutoClicker.toString()
);
...
if (
  parseInt(localStorage.getItem('priceAutoClicker') || '50') > priceAutoClicker
) {
  for (
    let i = 0;
    i < parseInt(localStorage.getItem('numberPurchaseAutoClick') || '0');
    i++
  ) {
...
let bonusPriceMultiplier: number = parseInt(
  localStorage.getItem('priceMultiplier') || priceMultiplier.toString()
);
...
let bonusPriceMultiplier5: number = parseInt(
  localStorage.getItem('priceMultiplier5') || priceMultiplier5.toString()
);
...
let bonusPriceMultiplier10: number = parseInt(
  localStorage.getItem('priceMultiplier10') || priceMultiplier10.toString()
);
...
function multiplier10() {
  if (score >= bonusPriceMultiplier10) {
    ...
    localStorage.setItem(
      'priceMultiplier10',
      bonusPriceMultiplier10.toString()
    );
    return true;
  } else {
    return false;
...
let bonusPriceTime: number = parseInt(
  localStorage.getItem('priceTime') || priceBonusTime.toString()
);
